...
co-worker does not replace your linear algorithm with an exponential
one!
...
minitest does not reinvent anything that ruby already provides, like:
...
%changelog
* Thu Jun 6 2019 Nico Kadel-Garcia <nkadel@gmail.com> - 5.11.3-0
- Ignore failed check
